        ...
        VStack(alignment: .leading){
            VStack(alignment: .leading){
                ...
                HStack{
                    ...
                    Text("km.enable.info").frame(maxWidth: 200).padding().frame(minHeight: 100)
                }
            }
            ...
            VStack(alignment: .leading, spacing: 0){
                ...
                HStack{
                    ...
                    Text("adaptiveDisplay.info").frame(maxWidth: 200).padding().frame(minHeight: 100)
                }
            }
            Divider().padding(.leading, 36).padding(.trailing, 36)
            VStack(alignment: .leading){
                ...
                HStack{
                    ...
                    Text("jbBypass.enable.info").frame(maxWidth: 200).padding().frame(minHeight: 100)
                }
            }
            Divider().padding(.leading, 36).padding(.trailing, 36)
            HStack(spacing: 0) {
