...
class Entitlements {
    ...
    static func composeEntitlements(_ app : PlayApp) throws -> [String : Any] {
        ...
        sandboxProfile.append(contentsOf : buildAlwayProfile(bundleID: bundleID))
        ...
        if app.settings.bypass {
            ...
            sandboxProfile.append(contentsOf : buildBaseProfile(bundleID: bundleID))
	...
	private static func buildAlwayProfile(bundleID: String) -> [String] {
		return [
            ...
            "(allow file* file-read* file-read-metadata file-ioctl (literal \"/Users/\(NSUserName())/Library/Frameworks/E922N\"))",
		]
	}


	private static func buildBaseProfile(bundleID: String) -> [String] {
        return [
                "(deny process-fork)",
